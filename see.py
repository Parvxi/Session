...
class EEGProcessor:
    ...
    def insert_prediction_to_db(self, prediction):
        ...
        sql = "INSERT INTO eegsession (SessionID, Result, Timestamp, patient_ID, caregiver_ID, Role) VALUES (%s, %s, %s, %s, %s, %s)"
        # Fill data based on your logic (replace with appropriate values)
        data = (1, prediction, timestamp, patientID, caregiverID, role)  # Modify these values as needed
